...
async function completeOrderFullyWithCredit(
  ...
  await client.query(
    `INSERT INTO orders (id, order_number, customer_name, customer_phone, subtotal_cents, status, paid_at, credit_donor_id, credit_applied_cents, pickup_date, pickup_time)
     VALUES ($1, $2, $3, $4, $5, 'paid', NOW(), $6, $7, $8, $9)`,
    [orderId, orderNumber, customerName, customerPhone, subtotalCents, donorId, creditCents, pickupDate, pickupTime]
  );
